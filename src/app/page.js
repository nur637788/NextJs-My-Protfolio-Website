...
function page() {
  return (
    <div className='min-h-screen '>
      ...
      <div className="h-96 mt-5 m-auto bg-gradient-to-l from-green-500 via-pink-600 to-blue-700 flex flex-col justify-center items-center space-y-10 rounded-xl">
