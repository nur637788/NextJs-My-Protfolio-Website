    ...
    <section className="min-h-screen bg-white text-gray-900">
      ...
      <div
        ...
        <div className="mx-auto">
          <div  className=" h-60 w-full md md:h-80 rounded-2xl overflow-hidden border-4 border-pink-500  shadow-lg hover:scale-105 transition duration-300">
          ...
          <div className="mt-8 flex justify-evenly">
            ...
            {/* Veiw Resume Button */}
            <button className="border-2 border-blue-700 rounded-md font-extralight text-black py-2 px-3 hover:text-white hover:scale-95 duration-300 hover:bg-blue-800"><a href="">Download CV</a></button>
          </div>
        </div>
        ...
        <div className="flex-1 space-y-6">
          ...
          <div data-aos="fade-up" className="bg-gray-900 p-4 rounded-xl border border-pink-600/30 shadow-md">
            ...
            <div className="flex flex-wrap gap-3">
              {["HTML", "CSS", "JavaScript", "React", "Next.js", "Tailwind", "Rersponsive", "Git", "GitHub", "Netlify", "Figma"].map((skill) => (
                <span
                  key={skill}
