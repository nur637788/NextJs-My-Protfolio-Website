  ...
  return (
    <main className="flex flex-col justify-center items-center text-center text-black ">
      ...
      <div data-aos="fade-up" className="">
        <div className="w-41 h-41 rounded-full border-4 border-blue-600 hover:border-l-pink-900 hover:border-r-pink-900 hover:border-b-pink-900 hover:scale-110 duration-300 shadow-lg m-auto cursor-pointer">
          <img className="w-40 h-40 rounded-full m-auto" src="/profile-image.jpg" alt="" />
        </div>
        <h1 className="text-2xl sm:text-4xl font-bold text-pink-500 mt-4">
          Hello, I'm <span className="font-extrabold text-pink-600">Abdun Nur</span>
        </h1>

        <h2 className="text-xl sm:text-2xl mt-4 text-blue-700 font-bold">
          <span className=" text-red-600 font-normal">  I'm a {" "} </span>
          <ReactTyped
            strings={[
              "Web Designer",
              "Frontend Developer ",
        ...
        <p className="text-gray-800 mt-4 text-lg leading-relaxed max-w-[600px]">
